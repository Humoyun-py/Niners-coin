...
def get_teachers_rating():
    ...
    # Join Teacher with User to get names, and calculate coins they helped students earn
    # Note: Currently we don't have performer_id, so we'll approximate by coins earned in their classes
