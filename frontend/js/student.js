const StudentModule = {
    ...
    async initShop() {
        ...
        try {
            ...
            const items = [
                { name: "Pen", price: 20, color: "🟡", stock: 20 },
                { name: "Termos", price: 120, color: "🟡", stock: 10 },
                { name: "10% discount", price: 50, color: "🟡", stock: 50 },
                { name: "20% discount", price: 90, color: "🟡", stock: 50 },
                { name: "50% discount", price: 150, color: "🟡", stock: 50 },
                { name: "100% discount", price: 250, color: "🟡", stock: 50 },
                { name: "Business lunch with CEO", price: 250, color: "🟡", stock: 20 },
                { name: "Bag", price: 150, color: "🟡", stock: 50 },
                { name: "Cap", price: 50, color: "🟡", stock: 2 },
                { name: "T-shirt", price: 50, color: "🟡", stock: -1 },
                { name: "Note", price: 100, color: "🟡", stock: -1 },
                { name: "IELTS book", price: 200, color: "🟡", stock: 10 },
                { name: "Upper intermediate book", price: 200, color: "🟡", stock: 15 },
                { name: "Intermediate book", price: 200, color: "🟡", stock: 5 },
                { name: "Pre intermediatre book", price: 200, color: "🟡", stock: 20 },
                { name: "elementary book", price: 200, color: "🟡", stock: 10 },
                { name: "beginner book", price: 200, color: "🟡", stock: 30 },
                { name: "IELTS exam", price: 1000, color: "🟡", stock: 8 },
                { name: "iPhone 17 pro max", price: 3200, color: "🟡", stock: 6 },
                { name: "iPhone 16 pro max", price: 3000, color: "🟡", stock: 3 },
                { name: "Redmi", price: 500, color: "🟡", stock: 10 },
                { name: "TV", price: 1500, color: "🟡", stock: 5 },
                { name: "Play Station", price: 1500, color: "🟡", stock: 3 },
                { name: "Samsung S25 Ultra", price: 3000, color: "🟡", stock: 3 },
            ];
            ...
            container.innerHTML = items.map(item => {
                ...
                const fallbackImages = {
                    'Bag': '/assets/Group%2024.jpg',
                    'Pen': '/assets/Group%2013.jpg',
                    'Note': '/assets/Group%2014.jpg',
                    '10% discount': '/assets/Group7.jpg',
                    '20% discount': '/assets/Group8.jpg',
                    '50% discount': '/assets/Group9.jpg',
                    '100% discount': '/assets/Group10.jpg',
                    ...
                    'Play Station': '/assets/Group%206.jpg',
                    // Books
                    'IELTS book': '/assets/Group%2021.jpg',
                    'ielts exam': '/assets/Group%2023.jpg',
                    'upper intermediate book': '/assets/Group%2020.jpg',
                    'intermediate book': '/assets/Group%2019.jpg',
                    'Pre intermediatre book': '/assets/Group%2018.jpg',
